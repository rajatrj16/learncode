...
6. Write a Python program to find whether a given number (accept from the user) is even or odd, print out an appropriate message to the user

7. Write a Python program to test whether a passed letter is a vowel or not. 

8. Write a Python program to compute the greatest common divisor (GCD) of two positive integers.
...
11. Write a Python program to locate Python site-packages.

12.  Write a python program to get the path and name of the file that is currently executing

13.  Write a Python program to swap two variables without using third variable.

14. Write a Python program to prove that two string variables of same value point same memory location.

15. Write a Python program to display the examination schedule. 
